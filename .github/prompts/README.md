...
| ----------------------------- | ---------------------------------- |
| `summarize-text.prompt.yml`   | Summarization                      |
| `generate-text.prompt.yml`    | Text generation                    |
| `answer-questions.prompt.yml` | Grounded Q&A                       |
| `edge-cases.prompt.yml`       | Empty input / error-style handling |
