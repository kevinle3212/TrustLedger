	...
	return (
		<svg viewBox="0 0 240 220" role="img" aria-hidden="true" className="h-auto w-full max-w-72">
			...
			<g className="tl-cow-walker">
				{/* Face the direction of travel. The journey animation carries this
				    group left→right, so the art is mirrored to face right; otherwise
				    the left-facing cow reads as walking backwards. */}
				<g className="tl-cow-facing">
					{/* Legs */}
					<g
