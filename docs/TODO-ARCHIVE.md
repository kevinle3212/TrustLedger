...
Completed to-do items moved out of the root `TODO.md` to keep the working list
small. Newly completed items land in `TODO.md` under `## Completed` and are
...
- [x] Document the GitHub Pages setup and deployment process in the README or a
    ...
    - [x] Pages were broken and all returned a 404. — The root cause was
          `Home.md` using bare link targets without the `.md` suffix; MkDocs
