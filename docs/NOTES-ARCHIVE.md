...
- [Research and Ideas](#research-and-ideas)
    - [Phase 7 Security and Consistency Sweep (2026-06-11)](#phase-7-security-and-consistency-sweep-2026-06-11)
    - [Phase 1 Package Migration Follow-Ups (2026-06-10)](#phase-1-package-migration-follow-ups-2026-06-10)
    - [Phase 4 AI Summary Hosting Plan (2026-06-10)](#phase-4-ai-summary-hosting-plan-2026-06-10)
    - [Free-Tier API Provider Survey (2026-06-06)](#free-tier-api-provider-survey-2026-06-06)
        - [AI Providers — Contract Summarization and Moderation](#ai-providers--contract-summarization-and-moderation)
            - [Google Gemini API (Gemini 2.5 Flash)](#google-gemini-api-gemini-25-flash)
            - [Groq](#groq)
            - [OpenRouter (`:free` models)](#openrouter-free-models)
            - [Cloudflare Workers AI](#cloudflare-workers-ai)
            - [Mistral (La Plateforme — Experiment Tier)](#mistral-la-plateforme--experiment-tier)
            - [Together AI](#together-ai)
            - [AI Provider Summary](#ai-provider-summary)
        - [Email / Transactional (Magic-Link Authentication)](#email--transactional-magic-link-authentication)
            - [Resend _(currently in use)_](#resend-currently-in-use)
            - [Brevo (formerly Sendinblue)](#brevo-formerly-sendinblue)
            - [Postmark](#postmark)
            - [Mailgun](#mailgun)
            - [SendGrid](#sendgrid)
            - [Email Provider Summary](#email-provider-summary)
        - [RPC / Blockchain Node Access](#rpc--blockchain-node-access)
            - [Alchemy](#alchemy)
            - [Infura](#infura)
            - [QuickNode](#quicknode)
            - [Public / Community RPC Endpoints](#public--community-rpc-endpoints)
            - [RPC Summary](#rpc-summary)
        - [IPFS / Storage Pinning](#ipfs--storage-pinning)
            - [Pinata _(currently in use)_](#pinata-currently-in-use)
            - [Filebase](#filebase)
            - [web3.storage / Storacha](#web3storage--storacha)
            - [IPFS Summary](#ipfs-summary)
        - [Price / Oracle Data Feeds](#price--oracle-data-feeds)
            - [CoinGecko API](#coingecko-api)
            - [CoinMarketCap API](#coinmarketcap-api)
            - [Chainlink Data Feeds (On-Chain)](#chainlink-data-feeds-on-chain)
            - [Price Data Summary](#price-data-summary)
        - [Overall Recommendations Summary](#overall-recommendations-summary)
    - [Cost Optimization and Alternatives Matrix (2026-06-08)](#cost-optimization-and-alternatives-matrix-2026-06-08)
        - [Service Cost Matrix](#service-cost-matrix)
        - [Deployment Recommendations](#deployment-recommendations)
        - [Highest-Impact Cost Controls](#highest-impact-cost-controls)
- [Decisions](#decisions)
    - [Supabase Evaluation (2026-06-08)](#supabase-evaluation-2026-06-08)
        - [Features That Would Benefit From Supabase](#features-that-would-benefit-from-supabase)
        - [Comparison Against Current Architecture](#comparison-against-current-architecture)
        - [If Supabase Is Adopted](#if-supabase-is-adopted)
        - [Trade-Offs](#trade-offs)
    - [Off-chain database: PostgreSQL + Prisma on Neon (2026-07-01)](#off-chain-database-postgresql--prisma-on-neon-2026-07-01)
    - [AI infrastructure: provider-agnostic core (2026-07-01)](#ai-infrastructure-provider-agnostic-core-2026-07-01)
    - [Wallet session persistence across navigation (2026-07-01)](#wallet-session-persistence-across-navigation-2026-07-01)

<!-- docs-toc:end -->

Long-lived research notes and decision history moved out of the root `NOTES.md`
to keep it operational. Newer notes accumulate in `NOTES.md` and are
periodically moved here.
