...
# written to audits/<type>/<UTC-timestamp>-<slug>.md with git metadata prefilled.
set -euo pipefail
...
VALID_TYPES="general security accessibility performance frontend backend infrastructure testing deployment dependencies"

usage() {
	echo "Usage: npm run audit:new -- <type> \"<short title>\"" >&2
